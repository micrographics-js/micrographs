...
import {
  ...
  // Pack 9 — Censorship
  RedactedText, ClassifiedStamp, CensorBar, DocumentHeader, SanitizedBlock,
  CaseFile, Declassified, Watermark, IntelBadge, SignatureRedact, EyesOnly, Codeword,
  // Pack 10 — Drone Warfare
  DroneHUD, AltitudeLadder, TargetLock, ThermalOverlay, TelemetryStrip,
  WeaponStatus, GimbalIndicator, FlightPath, LatLongDisplay, TransmissionBar,
  StrikeConfirm, MissionTimer,
