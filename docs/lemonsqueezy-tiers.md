...
3. Activation limit: 5 (allows 5 projects per key)
4. No expiration
...
Step 2 — Add license key to .env:

  MICROGRAPHICS_KEY={LICENSE_KEY}

  # Next.js: NEXT_PUBLIC_MICROGRAPHICS_KEY={LICENSE_KEY}
  # Vite: VITE_MICROGRAPHICS_KEY={LICENSE_KEY}
